...
python -u main.py --gpu 2 --epoch_n 50 --mode 1 --lamb 0.1 --log KTOT_0.2_reduce_shuffle
sleep 10

nohup python -u main.py --gpu 0 --epoch_n 50 --mode 1 --lamb 0.1 --log KTOT_0.5_reduce_shuffle > /dev/null &
nohup python -u main.py --gpu 1 --epoch_n 50 --mode 1 --lamb 0.1 --log KTOT_0.8_reduce_shuffle > /dev/null &
